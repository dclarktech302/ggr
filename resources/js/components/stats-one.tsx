        ...
        <section id="stats" className="py-12 md:py-20 scroll-mt-24">
            <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-16">
                <div className="relative z-10 mx-auto max-w-xl space-y-6 text-center">
                    <h2 className="text-4xl font-medium lg:text-5xl">GGR is local</h2>
                    <p>GGR is based in Maryland and Delaware. We are the central hub for music producers, artists, and DJs who are passionate about their music. Just like us</p>
                </div>
